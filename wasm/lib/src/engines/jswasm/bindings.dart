...
class Module {
  ...
  factory Module.fromBytes(Uint8List bytes) {
    return Module._fromBytesOrBuffer(bytes);
  }
  ...
  factory Module.fromBuffer(ByteBuffer buffer) {
    return Module._fromBytesOrBuffer(buffer);
  }
  ...
  bool operator ==(Object other) {
    return other is Module && other.jsObject == jsObject;
  }
  ...
  static Future<Module> fromBytesAsync(Uint8List bytes) {
    return _fromBytesOrBufferAsync(bytes);
  }
  ...
  static Future<Module> fromBufferAsync(ByteBuffer buffer) {
    return _fromBytesOrBufferAsync(buffer);
  }

  static Future<Module> _fromBytesOrBufferAsync(Object bytesOrBuffer) {
    return promiseToFuture<_Module>(_compile(bytesOrBuffer))
...
class Instance {
  ...
  Instance._(this.jsObject, this.module) {
    ...
    for (final key in _objectKeys(exportsObject).cast<String>()) {
      final value = getProperty<Object>(exportsObject, key);
  ...
  static Future<Instance> fromModuleAsync(
    ...
    return promiseToFuture<_Instance>(
      _instantiateModule(
        module.jsObject,
        _reifyImports(importMap, importObject),
      ),
    ).then((_instance) => Instance._(_instance, module)).catchError((Object e) {
      if (instanceof(e, _compileError)) {
        throw CompileError(getProperty(e, 'message'));
  ...
  static Future<Instance> fromBytesAsync(
    ...
    return _fromBytesOfBufferAsync(
      bytes,
      _reifyImports(
        importMap,
        importObject,
  ...
  static Future<Instance> _fromBytesOfBufferAsync(
    ...
    return promiseToFuture<_WebAssemblyInstantiatedSource>(
      _instantiate(
        bytesOrBuffer,
        imports,
      ),
  ...
  static Object _reifyImports(
    ...
    if (importMap != null) {
      final importObject = newObject<Object>();
      importMap.forEach((moduleName, module) {
        final moduleObject = newObject<Object>();
...
class Memory {
  ...
  @override
  bool operator ==(Object other) {
    return other is Memory && other.jsObject == jsObject;
  }
  ...
  static _MemoryDescriptor _descriptor(
    int initial,
    int? maximum,
    bool shared,
  ) {
...
class Table {
  ...
  @override
  bool operator ==(Object other) {
    return other is Table && other.jsObject == jsObject;
  }
...
class Global {
  ...
  @override
  bool operator ==(Object other) {
    return other is Global && other.jsObject == jsObject;
  }
...
extension JsBigInt on BigInt {
  ...
  Object toJs() {
    return _jsBigInt(toString());
  }

  /// Create from JavaScript `BigInt`.
  static BigInt toBigInt(Object jsBigInt) {
    return BigInt.parse(callMethod<String>(jsBigInt, 'toString', const []));
  }

  /// Returns `true` when the argument is a JavaScript `BigInt` value.
  static bool isJsBigInt(Object o) {
    final constructor = getProperty<Object>(o, 'constructor');
    final name = getProperty<String>(constructor, 'name');
    return name == 'BigInt';
  }
}
...
extension ModuleImportDescriptorKind on ModuleImportDescriptor {
  ...
  ImportExportKind get kind {
    return _importExportKindMap[getProperty(this, 'kind')]!;
  }
}
...
const Map<String, ImportExportKind> _importExportKindMap = {
...
@JS('Object.keys')
external List<Object> _objectKeys(
  Object value,
);
