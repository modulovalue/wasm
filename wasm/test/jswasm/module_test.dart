...
void main() {
  ...
  group('Size limit', () {
    ...
    test(
      ...
      () => expect(
        () => Module.fromBuffer(moduleBytes.buffer),
        throwsA(isA<ArgumentError>()),
      ),
      testOn: 'chrome',
    );
